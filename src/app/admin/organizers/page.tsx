  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-white/90 [text-shadow:0_1px_2px_rgba(0,0,0,0.5)]">Review and approve or reject applications from users in your campus who want to become organizers.</p>
      </div>
